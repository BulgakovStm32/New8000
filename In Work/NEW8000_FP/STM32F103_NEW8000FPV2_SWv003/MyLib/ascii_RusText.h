...
const char RusText_Saveing[]        = "Сохранение...";
const char RusText_ErrorConnectMB[] = "Нет связи с ЦП!!!";

const char RusText_PageMenuZone[] = "Линии Гр.";
const char RusText_LineSp[] = 			"Лин.Гр";
const char RusText_Zone1[] = 				"Лин.Гр1-";
const char RusText_Zone2[] = 				"Лин.Гр2-";
const char RusText_Zone3[] = 				"Лин.Гр3-";
const char RusText_Zone4[] = 				"Лин.Гр4-";
const char RusText_Zone5[] = 				"Лин.Гр5-";
const char RusText_Zone6[] = 				"Лин.Гр6-";
const char RusText_Att[] = 					"Лин.Ат";
const char RusText_Att1[] = 				"Лин.Ат1-";
const char RusText_Att2[] = 				"Лин.Ат2-";
const char RusText_Att3[] = 				"Лин.Ат3-";
const char RusText_Att4[] = 				"Лин.Ат4-";
const char RusText_Att5[] = 				"Лин.Ат5-";
const char RusText_Att6[] = 				"Лин.Ат6-";
...
//Состояния.
const char RusText_Attention[] = "ВНИМАНИЕ!";
const char RusText_Fire[]      = "ПОЖАР!";
const char RusText_Pusk[]      = "ПУСК";
...
const char RusText_Analyze[]   = "Анализ..";
//-------------------------------------------------------
//Питание блока
...
const char RusText_PageMenuOpoveshatel[] = "Световые табло";
const char RusText_Opoveshatel1[] =        "Табло1-";
const char RusText_Opoveshatel2[] =        "Табло2-";
const char RusText_Opoveshatel3[] =        "Табло3-";
const char RusText_PitanieOpovesh[] =      "Пит.табло=";
...
const char RusText_LockMode[]           = "Ключ <Блокировка>";
const char RusText_ControlMode[]        = "Ключ <Управление>";
const char RusText_ConfigMode[]         = "Ключ <Настройка>";
const char RusText_PojLineControlMode[] = "Управление ШС";

const char RusText_PLine[] = "Шлейф";
