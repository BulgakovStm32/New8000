...
//--------------------
#define RS485ProtocolLoopPeriod 50//10 //Период запросов протокола, в мС.
...
//--------------------
//Команды IP-платы.
#define CmdIPStatusConst         0x31 //Команда "Выдача статуса от IP".
...
uint8_t* RS485RxBuf   (uint8_t p);   //Получение указателя на байт в вприемном буфере.
...
//Ф-и для работы FP.
volatile FPDataUNION_TypeDef* RS485FP_TxBufSet       (void);
