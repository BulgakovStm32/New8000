...
FPDataUNION_TypeDef    TxBufUNION;
          ...
          if(((uint8_t)(CRCtemp >> 8)     == RS485RxBufUNION.BLK[RS485RxBufUNION.STR.Size - 1]) &&
            ...
            {  
              ...
              switch(RS485RxBufUNION.STR.Type){
                  ...
                  break;
                  //-----------
                  //case(IP_TypeConst)://Данные IP.
                  //  RS485ProtocolFlagReg |=  RS485_IPNewDataFlag;
                  //break;
                  //-----------
                  //case(ZE_TypeConst)://Данные ZE.
...
uint8_t RS485FP_GetZoneFromMB(uint8_t ch){
  ...
  return (RS485RxBufUNION.BLK[ch] & ZoneMask);
}
//-----------------------------------------------------------------------------
